...
You'll notice above that your token store lives inside Blob Storage. And so you will need to bring your own Storage Account with a Blob Services container that'll be used as the token store.
